...
public class GamePacMan extends Canvas implements Runnable, KeyListener {
    ...
    public static final String TITLE = "NAMCAP_GROUP_2";
    ...
    public void render() {
        ...
        switch (STATE) {
            ...
            case GAME_MENU:// Display the menu of game
                ...
                g.drawImage(Toolkit.getDefaultToolkit().getImage("./sprites/BG_MAIN.jpg"), 0, 0, WIDTH, HEIGHT, null);
                break;
            case GAME_HOWTOPLAY:// Display the guide of the player
                g.drawImage(Toolkit.getDefaultToolkit().getImage("./sprites/BG_HOWTOPLAY.jpg"), 0, 0, WIDTH, HEIGHT, null);
                break;
            case GAME_ABOUT:// Display the information of DEV
                g.drawImage(Toolkit.getDefaultToolkit().getImage("./sprites/BG_ABOUT.jpg"), 0, 0, WIDTH, HEIGHT, null);
                break;
            case GAME_QUIT://Display the frame thank you player then quit the game
                if (quitStartTime == 0) {
                    quitStartTime = System.currentTimeMillis();
                }
                g.drawImage(Toolkit.getDefaultToolkit().getImage("/sprites/BG_QUIT.jpg"), 0, 0, WIDTH, HEIGHT, null);
            ...
            case GAME_WIN:// Display the frame when the player win the game
                g.drawImage(Toolkit.getDefaultToolkit().getImage("/sprites/BG_WIN.jpg"), 0, 0, WIDTH, HEIGHT, null);
            ...
            case GAME_OVER:// Display the frame when the player lose the game
                g.drawImage(Toolkit.getDefaultToolkit().getImage("/sprites/BG_LOSE.jpg"), 0, 0, WIDTH, HEIGHT, null);
            ...
            case GAME_STAT:// Display the statistics of the player
                ...
                g.drawImage(Toolkit.getDefaultToolkit().getImage("/sprites/BG_STAT.jpg"), 0, 0, WIDTH, HEIGHT, null);
